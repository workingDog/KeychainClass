...
class KeyStoreService {
    ...
    static func setKey(key: String) {
        do {
            ...
            print("KeyStoreService setKey(), KeychainInterface.savePassword: \(error)")
        }
    }
    ...
    static func updateKey(key: String) {
        do {
            ...
            print("KeyStoreService updateKey(), KeychainInterface.updatePassword: \(error)")
        }
    }
    ...
    class KeychainInterface {
        ...
        static var service = "yoyo.com.myapp"
        static var account = "yoyo.myapp.apikey"
